...
- when the `list` feature is enabled, `{StructName}List` append, indexed insertion, indexed lookup, index-aware mutation, removal, `pop`, `clear`, and sorting, with the same visibility as the record struct
