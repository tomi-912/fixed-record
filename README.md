...
- when the `list` feature is enabled, `{StructName}List` append, indexed insertion, lookup, range search, index-aware mutation, removal, `pop`, and sorting, with the same visibility as the record struct
